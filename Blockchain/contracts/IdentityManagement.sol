...
contract IdentityManagement
{
    ...
    */
    ...
    function ViewDLRequestHeader(address UserAddress, uint RequestIndex) public view returns(string RequestedBy, uint DL_OverAll_Status)
    {
    ...
    function ViewDLRequestDetail(address UserAddress, uint RequestIndex) public view returns(string RequestedBy, uint DL_No, uint DL_Name, uint DL_DOB, uint DL_Hash, uint DL_Address, uint DL_OverAll_Status)
    {
        DLRequest ThisDLRequest=DLRequestMap[UserAddress][RequestIndex];
    ...
    function viewUser(address UserAddress, uint UserIndex) public view returns(string FullName,string EmailID,uint MobileNo)
    {
        UserInfo ThisUser=UserMap[UserAddress][UserIndex];
        return (ThisUser.FullName, ThisUser.EmailID, ThisUser.MobileNo);
    }

    function viewUserDL(address UserAddress, uint RequestIndex) public view returns(uint DL_No_S, string DL_No_V, uint DL_Name_S, string DL_Name_V, uint DL_DOB_S, string DL_DOB_V, uint DL_Hash_S, bytes DL_Hash_V, uint DL_Address_S, string DL_Address_V)
    {
